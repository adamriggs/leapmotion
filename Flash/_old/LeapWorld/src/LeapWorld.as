...
package {
	...
	public class LeapWorld extends Sprite {
		...
		//const
		public const NAME:String="leapWorld";
		public const RETURNTYPE:String=NAME;
		
		public function LeapWorld(){
			utils.em=EventManager.instance;
			utils.em.listen(NAME, onLeapWorld);
		...
		private function onLeapWorld(e:MuleEvent):void{
			/*debug("onLeapWorld()");
