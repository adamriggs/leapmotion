...
package {
	...
	public class LeapOutput extends Sprite {
		...
		//const
		public const NAME:String="leapOutput";
		public const RETURNTYPE:String=NAME;
		
		public function LeapOutput(){
			utils.em=EventManager.instance;
			utils.em.listen(NAME, onLeapOutput);
		...
		private function onLeapOutput(e:MuleEvent):void{
			/*debug("onLeapOutput()");
