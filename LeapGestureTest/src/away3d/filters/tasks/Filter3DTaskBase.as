...
package away3d.filters.tasks
{
	...
	public class Filter3DTaskBase
	{
		...
		protected function updateProgram3D(stage : Stage3DProxy) : void
		{
			...
			_program3D.upload(	new AGALMiniAssembler.assemble(Context3DProgramType.VERTEX, getVertexCode(), Debug.active),
								new AGALMiniAssembler.assemble(Context3DProgramType.FRAGMENT, getFragmentCode(), Debug.active));
